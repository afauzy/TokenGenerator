...
To optimize the TokenGenerator application for production, run:
...
[Doing API-First development]: http://www.jhipster.tech/documentation-archive/v4.10.0/doing-api-first-development/
